...
export const RAUM_FUER_KLANG_MEDIA = {
    hero: placeholderSvg({
        width: 960,
        height: 1120,
        title: "Foto folgt",
...
export function pendulumTraceMarkup() {
...
function placeholderSvg(options) {
...
function escapeSvgText(value) { return value.replaceAll("&", "&amp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;"); }
